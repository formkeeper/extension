...
/*
  Since the standard webpack.config.dev.js won't work for browser extensions
  this is a dev config based on the production template to output development
  builds
*/
...
module.exports = {
  ...
  resolve: {
    ...
    plugins: [
      ...
      // src/ with babel. To fix this, we prevent you from importing files
      // out of src/ -- if you'd like to, please link the files into your
      // node_modules/ and let module-resolution kick in. Make sure your source
      // files are compiled, as they will not be processed in any way.
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          // a single CSS file in production instead of JS code injecting
          // <style> tags.
          // If you use code splitting, however, any async bundles will still
          // use the "style" loader inside the async code so CSS from them won't
